    ...
    def do_GET(self):
        try:
            ...
            if ruta == '/login':
                ...
                html = paginas.pagina_login(mensaje="Debes iniciar sesion primero.")
            elif ruta == '/':
                ...
                sesion.clear()
                html = paginas.pagina_login(mensaje="Sesion cerrada correctamente.")
            else:
                html = paginas.pagina_404()
        ...
        try:
            ...
            if ruta == '/login':
                ...
                if est:
                    ...
                    html = paginas.pagina_login(
                        mensaje="Nombre o contrasena incorrectos."
                    )
                ...
                if 'id_estudiante' not in sesion:
                    ...
                    html = paginas.pagina_error(
                        "Debes seleccionar una opcion antes de responder.",
                ...
                if not mensaje:
                    self._enviar_json({'respuesta': 'Escribe una pregunta.'})
                    return
                datos_n8n = json.dumps({'mensaje': mensaje}).encode('utf-8')
                req = urllib.request.Request(
                    'https://swrblack.app.n8n.cloud/webhook/chatbot',
                    data=datos_n8n,
                ...
                try:
                    ...
                    respuesta = f'Error al conectar con el asistente: {str(e)}'
                self._enviar_json({'respuesta': respuesta})
                return
